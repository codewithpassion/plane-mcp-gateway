/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: 8307f8f35b04f12123e5a2d8bb480d34)
...
interface __BaseEnv_Env {
	...
	MCP_OBJECT: DurableObjectNamespace<import("./app/server").MyMCP>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_CLIENT_ID" | "CLERK_CLIENT_SECRET" | "CLERK_SECRET_KEY" | "CLERK_FRONTEND_API" | "VITE_CLERK_PUBLISHABLE_KEY" | "CLERK_PUBLISHABLE_KEY" | "COOKIE_ENCRYPTION_KEY" | "PLANE_API_KEY">> {}
}
